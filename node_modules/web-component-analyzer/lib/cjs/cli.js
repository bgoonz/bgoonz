...
function analyzeGlobs(globs, config, context) {
    ...
    return transformAnalyzerResult.__awaiter(this, void 0, void 0, function () {
        var filePaths, _j, program, files, diagnostics, results, _loop_1, files_1, files_1_1, file, e_1_1;
        var e_1, _k;
        return transformAnalyzerResult.__generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    // Set default glob
                    if (globs.length === 0) {
                ...
                case 1:
                    ...
                    // Callbacks
                    (_b = (_a = context).didExpandGlobs) === null || _b === void 0 ? void 0 : _b.call(_a, filePaths);
                    (_d = (_c = context).willAnalyzeFiles) === null || _d === void 0 ? void 0 : _d.call(_c, filePaths);
                    _j = compileTypescript(filePaths), program = _j.program, files = _j.files, diagnostics = _j.diagnostics;
                    if (diagnostics.length > 0) {
                        logVerbose(function () { return diagnostics.map(function (d) { return ((d.file && d.file.fileName) || "unknown") + ": " + tsModule.flattenDiagnosticMessageText(d.messageText, "\n"); }); }, config);
                        (_f = (_e = context).didFindTypescriptDiagnostics) === null || _f === void 0 ? void 0 : _f.call(_e, diagnostics, { program: program });
                    }
                    results = [];
                        ...
                        return transformAnalyzerResult.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    // Callback
                                    return [4 /*yield*/, ((_h = (_g = context).emitAnalyzedFile) === null || _h === void 0 ? void 0 : _h.call(_g, file, result, { program: program }))];
                                case 1:
                                    // Callback
                                    _a.sent();
                                    results.push(result);
                ...
                case 8:
                    try {
                        if (files_1_1 && !files_1_1.done && (_k = files_1.return)) _k.call(files_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                    return [7 /*endfinally*/];
                case 9: return [2 /*return*/, { program: program, diagnostics: diagnostics, files: files, results: results }];
            }
        });
    });
}
...
function expandGlobs(globs, config) {
    ...
    return transformAnalyzerResult.__awaiter(this, void 0, void 0, function () {
        var ignoreGlobs, _b;
        return transformAnalyzerResult.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    globs = Array.isArray(globs) ? globs : [globs];
                    ignoreGlobs = ((_a = config) === null || _a === void 0 ? void 0 : _a.discoverLibraryFiles) ? [] : IGNORE_GLOBS;
                    _b = transformAnalyzerResult.arrayFlat;
...
var analyzeCliCommand = function (config) { return transformAnalyzerResult.__awaiter(void 0, void 0, void 0, function () {
    var inputGlobs, outConsole, context, _a, results, program, filteredResults, outputResultMap, outputResultMap_1, outputResultMap_1_1, _b, outputPath, results_1, tagNames, content;
    var e_1, _c;
    var _d;
    return transformAnalyzerResult.__generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                if (config.format === "json" || ((_d = config.outFile) === null || _d === void 0 ? void 0 : _d.endsWith(".json"))) {
                ...
                outConsole = config.outDir == null && config.outFile == null && config.outFiles == null;
                context = {
            ...
            case 1:
                ...
                if (!!outConsole) return [3 /*break*/, 3];
                filteredResults = results.filter(function (result) { return result.componentDefinitions.length > 0 || result.globalFeatures != null; });
...
function transformResults(results, program, config) {
    ...
    var transformerConfig = {
        visibility: (_a = config.visibility, (_a !== null && _a !== void 0 ? _a : "public")),
...
function cli() {
    return transformAnalyzerResult.__awaiter(this, void 0, void 0, function () {
        ...
        var _this = this;
        return transformAnalyzerResult.__generator(this, function (_a) {
            argv = yargs.usage("Usage: $0 <command> [glob..] [options]")
                .command({
