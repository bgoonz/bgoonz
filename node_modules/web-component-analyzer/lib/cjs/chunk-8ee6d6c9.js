                    ...
                    if (ts.isPropertySignature(member)) {
                        ...
                        if (name_1 != null && typeof name_1 === "string") {
                            events.push({
                                ...
                                name: name_1,
                                type: lazy(function () { return ({ kind: tsSimpleType.SimpleTypeKind.ANY }); })
                            });
                        }
                    }
                }
...
function discoverInheritance(node, context) {
    ...
    if (context.ts.isClassLike(node) || context.ts.isInterfaceDeclaration(node)) {
        ...
        var clauses_1 = [];
        resolveHeritageClauses(node, exports.__assign(exports.__assign({}, context), { emitHeritageClause: function (clause) { return clauses_1.push(clause); } }));
        return clauses_1;
    }
    return undefined;
}
    ...
    if (ts.isCallExpression(node)) {
        ...
        try {
            for (var args_1 = __values(args), args_1_1 = args_1.next(); !args_1_1.done; args_1_1 = args_1.next()) {
                ...
                resolveHeritageClause(heritage, arg, exports.__assign(exports.__assign({}, context), { emitHeritageClause: function (clause) { return horizontalInheritance_1.push(clause); } }));
            }
        }
        ...
        if (identifier != null && ts.isIdentifier(identifier)) {
            ...
            resolveMixin(heritage, identifier, exports.__assign(exports.__assign({}, context), { emitHeritageNode: function (heritageNode) {
        ...
        for (var declarations_2 = __values(declarations), declarations_2_1 = declarations_2.next(); !declarations_2_1.done; declarations_2_1 = declarations_2.next()) {
            ...
            if (declaration.getSourceFile().isDeclarationFile) {
                findChildren(declaration, ts.isIdentifier, function (identifier) {
                    ...
                    resolveMixin(heritage, identifier, exports.__assign(exports.__assign({}, context), { emitHeritageNode: function (n) {
...
function relaxType(type) {
    switch (type.kind) {
        ...
        case tsSimpleType.SimpleTypeKind.NULL:
        case tsSimpleType.SimpleTypeKind.UNDEFINED:
            return { kind: tsSimpleType.SimpleTypeKind.ANY };
        default:
            return type;
    }
...
var refineFeature = {
    member: function (memberResult, context) {
        ...
        if (member.visibility == null) {
            ...
            if (isNamePrivate(name_1)) {
                return exports.__assign(exports.__assign({}, memberResult), { member: exports.__assign(exports.__assign({}, member), { visibility: "private" }) });
            }
        }
        return memberResult;
    },
    method: function (method, context) {
        ...
        if (method.visibility == null && isNamePrivate(method.name)) {
            return exports.__assign(exports.__assign({}, method), { visibility: "private" });
        }
        return method;
    }
};
            ...
            return parseJsDocForNode(node, ["event", "fires", "emits"], function (tagNode, _a) {
                ...
                if (name != null && name.length > 0 && tagNode != null) {
                    return {
                        name: name,
                        jsDoc: description != null ? { description: description } : undefined,
                        type: lazy(function () { return (type && parseSimpleJsDocTypeExpression(type)) || { kind: tsSimpleType.SimpleTypeKind.ANY }; }),
                        typeHint: type,
                        node: tagNode
                    };
                }
...
function applyJsDocAttribute(feature, jsDoc) {
    ...
    if (attributeTag != null && feature.attrName == null) {
        return exports.__assign(exports.__assign({}, feature), { attrName: attributeTag.parsed().name || feature.propName });
    }
    return feature;
}
/**
...
function applyJsDocType(feature, jsDoc) {
    ...
    if (typeTag != null && feature.typeHint == null) {
        ...
        if (parsed_1.type != null && parsed_1.type.length > 0) {
            return exports.__assign(exports.__assign({}, feature), { typeHint: parsed_1.type, type: (_b = feature.type, (_b !== null && _b !== void 0 ? _b : lazy(function () { return parseSimpleJsDocTypeExpression(parsed_1.type || ""); }))) });
        }
    }
    return feature;
}
        ...
        return [
            {
                ...
                member: {
                    ...
                    type: lazy(function () {
                        ...
                        return inJavascriptFile && typeof litConfig.type === "object" && litConfig.type.kind === tsSimpleType.SimpleTypeKind.ANY ? litConfig.type : propType;
                    }),
                    node: node,
                    default: def,
                    required: required,
        ...
        var _loop_1 = function (propNode) {
            ...
            memberResults.push({
                ...
                member: {
                    kind: "property",
                    type: lazy(function () {
                        return (jsDoc && getJsDocType(jsDoc)) || (typeof litConfig.type === "object" && litConfig.type) || { kind: tsSimpleType.SimpleTypeKind.ANY };
                    }),
                    propName: propName,
...
function makeContextFromConfig(options) {
    ...
    return {
        ...
        config: exports.__assign(exports.__assign({}, options.config), { analyzeLibDom: (_b = (_a = options.config) === null || _a === void 0 ? void 0 : _a.analyzeLibDom, (_b !== null && _b !== void 0 ? _b : false)), analyzeLib: (_d = (_c = options.config) === null || _c === void 0 ? void 0 : _c.analyzeLib, (_d !== null && _d !== void 0 ? _d : false)), excludedDeclarationNames: (_f = (_e = options.config) === null || _e === void 0 ? void 0 : _e.excludedDeclarationNames, (_f !== null && _f !== void 0 ? _f : [])), features: (_h = (_g = options.config) === null || _g === void 0 ? void 0 : _g.features, (_h !== null && _h !== void 0 ? _h : ALL_COMPONENT_FEATURES)) })
    };
}
...
function mergeJsDoc(leftJsDoc, rightJsDoc) {
    ...
    return exports.__assign(exports.__assign({}, ((leftJsDoc !== null && leftJsDoc !== void 0 ? leftJsDoc : rightJsDoc))), { description: (_a = leftJsDoc.description, (_a !== null && _a !== void 0 ? _a : rightJsDoc.description)) });
}
/**
 * Merges modifiers
 * @param leftModifiers
...
function mergeEvents(events) {
    return mergeNamedEntries(events, function (event) { return event.name; }, function (left, right) { return (exports.__assign(exports.__assign({}, left), { jsDoc: mergeJsDoc(left.jsDoc, right.jsDoc) })); });
}
...
function mergeMemberIntoMember(leftMember, rightMember, checker) {
    ...
    return exports.__assign(exports.__assign({}, leftMember), { attrName: (_a = leftMember.attrName, (_a !== null && _a !== void 0 ? _a : rightMember.attrName)), type: (function () {
            var _a, _b;
...
function visitAndExpandInheritClause(inheritClause, context, visitSet) {
    ...
    var resolved = (function () {
        ...
        return inheritClause.resolved.map(function (resolved) {
            ...
            return exports.__assign(exports.__assign({}, resolved), { inherits: inheritance });
        });
    })();
    return exports.__assign(exports.__assign({}, inheritClause), { 
...
function analyzeComponentDeclaration(initialDeclarationNodes, context) {
    ...
    context = exports.__assign(exports.__assign({}, context), { getDeclaration: function () { return baseDeclaration; } });
    try {
        ...
        for (var declarationNodes_1 = __values(declarationNodes), declarationNodes_1_1 = declarationNodes_1.next(); !declarationNodes_1_1.done; declarationNodes_1_1 = declarationNodes_1.next()) {
            ...
            featureCollections.push(discoverFeatures$1(node, exports.__assign(exports.__assign({}, context), { declarationNode: node })));
        }
    }
    catch (e_2_1) { e_2 = { error: e_2_1 }; }
    finally {
...
function discoverDefinitions$4(sourceFile, context, analyzeDeclaration) {
    ...
    return Array.from(definitionResults.entries()).map(function (_a) {
        ...
        return exports.__assign(exports.__assign({}, definition), { declaration: lazy(function () { return analyzeDeclaration(definition, Array.from(declarationSet)); }) });
    });
}
/**
...
function discoverGlobalFeatures$3(node, context) {
    ...
    return exports.__assign(exports.__assign({}, mergedFeatures), { members: mergedFeatures.memberResults.map(function (res) { return res.member; }) });
}
...
function analyzeSourceFile(sourceFile, options) {
    ...
    var componentDefinitions = discoverDefinitions$4(sourceFile, context, function (definition, declarationNodes) {
        ...
        return analyzeComponentDeclaration(declarationNodes, exports.__assign(exports.__assign({}, context), { getDeclaration: definition.declaration, getDefinition: function () { return definition; } }));
    });
...
function isSimpleType(value) {
    return value instanceof Object && "kind" in value && Object.values(tsSimpleType.SimpleTypeKind).includes(value.kind);
}
/**
...
function stripTypescriptValues(input, checker) {
    ...
    if (input == null) {
        ...
        return "{SIMPLE_TYPE:" + tsSimpleType.toTypeString(input) + "}";
    }
...
function getTypeHintFromType(type, checker) {
    ...
    if (typeof type === "string")
        return type;
    var typeHint = tsSimpleType.toTypeString(type, checker);
...
function componentMemberToVscodeAttr(member, checker) {
    ...
    return exports.__assign({ name: member.attrName, description: formatMetadata(formatEntryRow(member.attrName, member.jsDoc, member.typeHint || ((_b = (_a = member).type) === null || _b === void 0 ? void 0 : _b.call(_a)), checker), {
...
exports.generateInheritanceTreeText = generateInheritanceTreeText;
