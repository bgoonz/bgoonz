import { d as __awaiter, e as __generator, f as __values, b as analyzeSourceFile, h as arrayFlat, s as stripTypescriptValues, i as __read, _ as __assign, t as transformAnalyzerResult } from './chunk-9c416dae.js';
            ...
            switch (_l.label) {
                ...
                case 1:
                    ...
                    if (diagnostics.length > 0) {
                        logVerbose(function () { return diagnostics.map(function (d) { return ((d.file && d.file.fileName) || "unknown") + ": " + flattenDiagnosticMessageText(d.messageText, "\n"); }); }, config);
...
function cli() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var _this = this;
        return __generator(this, function (_a) {
            argv = usage("Usage: $0 <command> [glob..] [options]")
                .command({
